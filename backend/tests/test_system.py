...
def test_database():
    ...
    try:
        with engine.connect() as conn:
            ...
            print(f"OK - Database stato: {'READ-ONLY' if is_readonly else 'READ-WRITE'}")
            ...
            # Test vincoli
            result = conn.execute(text("SELECT COUNT(*) FROM information_schema.check_constraints WHERE constraint_schema = 'public'"))
