...
def ensure_ollama_nonblocking(
    app: FastAPI, retries: int = 3, wait: int = 2
) -> bool:
    """Try a few quick attempts to detect Ollama; set app.state flags and
    return readiness.
