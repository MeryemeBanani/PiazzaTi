            ...
            for batch_start in range(0, len(df), batch_size):
                ...
                if batch_embeddings:
                    try:
                        ...
                        print(f"✅ Batch stored: {len(batch_embeddings)} embeddings")
    ...
    def process_directory(
        ...
        for csv_file in csv_files:
            if skip_processed and csv_file in processed_files_set:
                print(f"⏭️  Skipping already processed file: {csv_file}")
        ...
        print(f"   📁 Files found: {overall_results['total_files_found']}")
        print(f"   ✅ Files processed: {overall_results['files_processed']}")
        print(f"   ⏭️  Files skipped: {overall_results['files_skipped']}")
        print(f"   📊 Total embeddings: {overall_results['total_embeddings_processed']}")
        ...
        while True:
            try:
                ...
                if results['files_processed'] > 0:
                    print(f"🔄 Processed {results['files_processed']} new files")
                ...
                print(f"❌ Error during directory watch: {e}")
