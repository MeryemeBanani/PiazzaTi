# -*- coding: utf-8 -*-
"""cv_json_to_dataset_processor.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13QOYB6whvZEmqRh3Ry5CzBZULuL0vMac
"""
    ...
    if files_to_add:
        ...
        for json_file in files_to_add:
            try:
                ...
                sha_preview = row['file_sha256'][:16] + "..." if row['file_sha256'] else "N/A"
